    ...
    <div class="d-flex flex-row">
        <div class="flex-grow-1 container">
            ...
            <div class="container" style="padding-top: 20%;">
                <p class="text-brand-primary fw-bold fs-2">Great Job! Your Application Is In 🥳</p>
                <p class="fs-6 text-secondary lh-lg" style="width: 80%">You are one step away from becoming a <span class="text-brand-secondary fw-bold">Journeolink Driver-Partner</span>! Our team will review your details and notify you once verification is complete  via email or your dashboard.</p>
