...
<head>
    ...
    <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
    <link href="https://fonts.googleapis.com/css2?family=Outfit:wght@100..900&display=swap" rel="stylesheet">
    <link rel="stylesheet" type="text/css" href="../../../public/css/driver-signup.css">
        ...
        <div class="flex-grow-1">
            ...
            <div>
                <div class="container d-flex flex-column justify-content-center gap-3 form-content-container" style="">
                    ...
                    <form action="../../../api/driver/auth.php" method="post" class="d-flex flex-column gap-3">
                        ...
                        <button type="submit" class="bg-brand-primary btn text-light primary-color mt-3">Sign Up</button>
                    </form>
