  ...
  <div class="container-fluid vh-100">
    <div class="row h-100 g-0">
      ...
      <div class="col-12 col-lg-6 d-flex flex-column position-relative h-100 p-5">
        ...
        <div>
          <p class="fw-bold position-absolute bottom-0 start-6" style="margin-left:-30px; color: #FAF0E6">@Quezon City</p>
        </div>
      </div>
        ...
        <div class="card p-4 shadow" style="width:450px; height:500px; flex-shrink:0; margin-top:40px;">
          ...
          <form action="loading.php" method="POST" style="width: 80%; margin: 0 auto;">
              ...
              <div class="row g-2">
                <div class="col">
                  <div class="input-group">
                    ...
                    <input type="text" name="first_name" class="form-control border-start-0" placeholder="First Name"
                ...
                <div class="col">
                  <div class="input-group">
                    ...
                    <input type="text" name="last_name" class="form-control border-start-0" placeholder="Last Name"
            ...
            <div class="mb-3">
              ...
              <div class="input-group">
                <span class="input-group-text bg-white border-end-0">
                  <img src="/users-payments-management-system/public/images/email%201.png" style="width:21px; height:21px;">
                </span>
            ...
            <!-- Buttons -->
            <button type="submit" name="signup" class="btn btn-brand w-100 mt-1 mb-3">Sign Up</button>
